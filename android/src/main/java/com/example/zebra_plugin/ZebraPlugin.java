package com.example.zebra_plugin;
 ...
 * ZebraPlugin
 */
public class ZebraPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    private void getAllPairedZQDevices(MethodCall call, Result result) {
        try{
            ...
            Log.i("ZEBRA PRINTER", "getAllPairedZQDevices: "+devices);
            result.success(devices);
        }catch (Exception e){
            Log.e("ZEBRA PRINTER", "getAllPairedZQDevices: "+e);
            result.success(null);
        }
    }
