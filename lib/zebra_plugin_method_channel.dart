...
import 'package:zebra_plugin/zebra_core.dart';

import 'zebra_plugin_platform_interface.dart';

/// An implementation of [ZebraPluginPlatform] that uses method channels.
class MethodChannelZebraPlugin extends ZebraPluginPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('zebra_plugin');
